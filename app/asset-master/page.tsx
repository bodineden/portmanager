...
export default async function AssetMasterPage() {
              ...
              <section id="asset-form" className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <form action={saveAssetAction}>
                  ...
                  <div className="mt-4 flex gap-2">
                    ...
                    <a href="/asset-master" className="grid h-10 place-items-center rounded-md border border-slate-200 px-4 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">Cancel</a>
                  </div>
                </form>
              </section>
            </aside>
