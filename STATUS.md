...
- Portfolio value time-series page added 2026-08-17 (/portfolio): daily total in THB from holding shares × as-of price × as-of FX, SVG chart + table. Verified current value matches holder list. Sol's full pass (2026-08-18) added range selector (1M/3M/6M/ALL) + monthly-average trend line.
- DATABASE_URL now available (Bodin shared 2026-08-18; keep out of git) — used for one-off SQL: cleaned 5 polluted price_history rows (VUAG 720.42 Aug 6 + 724.82 ×3 Aug 15/16/17, USPY 720.84 Aug 6 — XTB widget-trap values). Chart spikes gone, verified live: Aug 6 now +THB 270, Aug 16 +THB 0.

## Next actions
- None urgent — prices + FX cron daily; chart history clean after DB cleanup
